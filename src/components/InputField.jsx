    ...
    <div className={`space-y-1.5 w-full ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          required={required}
          className={`w-full px-4 py-3 rounded-xl bg-white border text-slate-900 placeholder-slate-400 text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-opacity-15 shadow-sm
            ${
              hasError
